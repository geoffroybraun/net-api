...
namespace GB.NetApi.Application.WebApi.IntegrationTests.Controllers.Persons
{
    public sealed class DeletePersonControllerTest : BasePersonControllerTest
    {
        ...
        [Fact]
        public async Task Deleting_a_person_without_being_authenticated_returns_an_unauthorized_status_code()
        {
        ...
        [Fact]
        public async Task Deleting_a_person_without_being_allowed_to_returns_a_forbidden_status_code()
        {
